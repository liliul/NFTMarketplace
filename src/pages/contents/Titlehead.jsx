    ...
    return (
        <>
            <section className="w-full h-[796px]">
                <article className="pt-[220px] sm:pt-[290px] px-4  max-w-[976px] m-auto">
                    <div className=" h-[260px] ">
                        ...
                        <h1 className='text-white font-fontMontserrat font-bold text-lg sm:text-3xl'>
                            The world's first non-fungible token (NFT) marketplace 
                            for both digital and physical assets.
                        </h1>

                        <div className='flex justify-center sm:flex sm:justify-start gap-8 w-full h-14 mt-16'>
                    ...
                    <div className='flex gap-8 mt-[150px]'>
                        ...
                        <b className='text-white text-sm sm:text-base font-bold font-fontUbuntu'>Learn more about TheFund</b>
                    </div>
                </article>
            </section>
        </>
