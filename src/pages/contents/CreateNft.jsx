    ...
    return (
        ...
        <>
            <section className="w-full lg:h-[524px] bg-create pt-20 pb-8">
                <article className="xl:ml-28 px-4 xl:px-0  h-auto xl:max-w-[1166px]  flex flex-col justify-between ">
                    <h1 className="text-white text-xl sm:text-2xl pb-8 font-fontMontserrat font-bold">Create and sell your NFTs</h1>

                    <section className="w-full md:flex lg:justify-between pr-4 flex justify-center flex-wrap gap-12">
